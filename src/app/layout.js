...
export default function RootLayout({ children }) {
  ...
  <path 
    ...
    1.857.344 1.054.048 1.37.058 4.041.058h.08c2.597 0 
    2.917-.01 3.96-.058.976-.045 1.505-.207 
    1.858-.344.466-.182.8-.398 1.15-.748.35-.35.566-.683.748-1.15.137-.353.3-.882.344-1.857.048-1.055.058-1.37.058-4.041v-.08c0-2.597-.01-2.917-.058-3.96-.045-.976-.207-1.505-.344-1.858a3.097 3.097 0 00-.748-1.15 
    ...
    1.2 0 110 2.4 1.2 1.2 0 010-2.4z" />
                  ...
                  <a href="https://youtube.com/@glowzialudhiana?si=5nLpP6gC8LsiT8pE" className="text-white">
                    ...
                    <svg className="h-6 w-6" fill="#FF0000" viewBox="0 0 576 512" xmlns="http://www.w3.org/2000/svg">
