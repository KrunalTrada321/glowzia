        ...
        <footer className="bg-gray-50 border-t">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              <div>
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Beauty Academy</h3>
                <p className="text-gray-600">Transform your passion into a successful career in beauty.</p>
              </div>
              <div>
                <h4 className="text-sm font-semibold text-gray-900 mb-4">Quick Links</h4>
                <ul className="space-y-2">
                  <li><a href="#" className="text-gray-600 hover:text-pink-600">About Us</a></li>
                  <li><a href="#" className="text-gray-600 hover:text-pink-600">Our Courses</a></li>
              ...
              <div>
                ...
                <ul className="space-y-2 text-gray-600">
                  ...
                  <li>contact@beautyacademy.com</li>
                  <li>(555) 123-4567</li>
                </ul>
              </div>
              <div>
            ...
            <div className="mt-8 pt-8 border-t border-gray-200">
              <p className="text-center text-gray-400 text-sm">
                © {new Date().getFullYear()} Beauty Academy. All rights reserved.
              </p>
            </div>
          </div>
        </footer>
